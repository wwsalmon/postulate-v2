import {type Descendant, Editor, Element, Node, Text, Transforms} from "slate";
import {unified} from "unified";
import markdown from "remark-parse";
import math from "remark-math";
import slate from "remark-slate";
import type { CustomEditor, CustomText } from "./slate";
...
export const isNodeEmpty = (node: Node): Boolean | CustomText[] => {
